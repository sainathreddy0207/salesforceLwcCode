...
export default class PdfGeneration extends LightningElement {
    @api recordId
    imageUrl = 'https://cyberpunk-dev-ed.lightning.force.com/lightning/r/User/0055g00000H9N6OAAV/view'
    invoiceData = {
        invoiceNo: '123',
        invoiceCreated: 'Dec 27, 2024',
        invoiceDue: 'Dec 27, 2024',
        companyName: 'Zomato, Inc.',
    ...
    pdfHandler() {
        ...
        generatePDF({ recordId: this.recordId, htmlData: content.outerHTML }).then(result => {
            ...
            window.open(`https://cyberpunk-dev-ed.file.force.com/servlet/servlet.FileDownload?file=${result.Id}`)
        }).catch(error => {
            console.error(error)
        })
    }
